...
//  Lokasi
const LAT = -2.335013;
const LNG = 115.461467;

function DetailMinuman3() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailminuman/DetailMinuman3.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        Juice Sultan Premium menghadirkan minuman jus
                        berkualitas yang dibuat dari buah-buahan segar pilihan.
                        Setiap sajian diproses dengan higienis untuk
                        menghasilkan rasa yang lezat, segar, dan alami. Dengan
                        kualitas bahan yang baik, Juice Sultan Premium menjadi
                        pilihan tepat bagi siapa saja yang ingin menikmati
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1minuman3.jpg",
                          title: "Jus Semangka",
                          price: "Rp 15.000",
                        },
                        {
                          img: "menu2minuman3.jpg",
                          title: "Jus jeruk sunkish",
                          price: "Rp 20.000",
                        },
                        {
                          img: "menu3minuman3.jpg",
                          title: "Jus Stawberry",
                          price: "Rp 15.000",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu4minuman3.jpg",
                          title: "Jus Alpukat",
                          price: "Rp 15.000",
                        },
                        {
                          img: "menu5minuman3.jpg",
                          title: "Jus Jeruk",
                          price: "Rp 15.000",
                        },
                      ].map((item, i) => (
