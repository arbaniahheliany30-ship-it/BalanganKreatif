...
//  Lokasi
const LAT = -2.468396;
const LNG = 115.501346;

function DetailJasa4() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailjasa/DetailJasa4.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        Ikhsan Service menyediakan layanan perbaikan berbagai
                        peralatan elektronik yang rusak, sehingga dapat
                        digunakan kembali tanpa perlu membeli yang baru. Dengan
                        keterampilan teknisi yang berpengalaman dan proses
                        pengerjaan yang teliti, Ikhsan Service membantu
                        mengatasi berbagai kerusakan elektronik secara cepat dan
                        efektif. Solusi tepat bagi Anda yang ingin menghemat
                        biaya sekaligus memperpanjang usia perangkat elektronik.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Kabang, Tariwin, Kab.Balangan, Kalimantan Selatan
                        </Popup>
                      </Marker>
                    </MapContainer>
                  </div>
