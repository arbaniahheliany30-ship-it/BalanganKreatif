...
//  Lokasi
const LAT = -2.37504;
const LNG = 115.501063;

function DetailMakanan6() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailmakanan/DetailMakanan6.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        Bakso dan Mie Ayam Mang Uji menyajikan bakso kenyal
                        dengan kuah kaldu gurih serta mie ayam lezat dengan
                        bumbu yang kaya rasa. Selain itu, tersedia juga menu
                        lainnya seperti nasi goreng, mie cuan, dan aneka
                        hidangan hangat lainnya. Semua dibuat fresh dan cocok
                        dinikmati kapan saja, terutama saat lapar dan ingin
                        makanan yang benar-benar mengenyangkan.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1makanan6.jpg",
                        },
                        {
                          img: "menu2makanan6.jpg",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu3makanan6.jpg",
                        },
                        {
                          img: "menu4makanan6.jpg",
                        },
                      ].map((item, i) => (
                        <Col md="4" sm="6" key={i} className="mb-4">
                          <img
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Jl. Tumenggung Jalil, Batu Piring, Kec. Paringin
                          Selatan
                        </Popup>
                      </Marker>
                    </MapContainer>
