...
//  Lokasi
const LAT = -2.343842;
const LNG = 115.459471;

function DetailMakanan3() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailmakanan/DetailMakanan3.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        UMKM Nisa Cake & Bakery adalah usaha kue rumahan yang
                        fokus menjual berbagai jenis kue bolu. Kue yang dibuat
                        selalu fresh setiap hari dengan rasa yang lembut dan
                        manis pas. Nisa Cake & Bakery menghadirkan pilihan bolu
                        yang cocok untuk camilan keluarga, acara kecil, ataupun
                        pesanan khusus. Dibuat secara sederhana namun penuh
                        perhatian, setiap bolu memiliki cita rasa khas yang
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1makanan3.jpg",
                          title: "Bolu Gulung",
                          price: "Rp 30.000",
                        },
                        {
                          img: "menu2makanan3.jpg",
                          title: "Bolu Zebra",
                          price: "Rp 45.000",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu3makanan3.jpg",
                          title: "Bolu Kismis",
                          price: "Rp 35.000",
                        },
                        {
                          img: "menu4makanan3.jpg",
                          title: "Risol Mentah",
                          price: "Rp 15.000",
                        },
                      ].map((item, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Komplek batu piring permai rt.14, Gg.Rajawali
                          no.140,Lingsir, Paringin Selatan
                        </Popup>
                      </Marker>
                    </MapContainer>
                  </div>
