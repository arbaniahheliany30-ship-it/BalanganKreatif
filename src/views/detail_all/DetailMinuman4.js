...
//  Lokasi
const LAT = -2.334596;
const LNG = 115.461531;

function DetailMinuman4() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailminuman/DetailMinuman4.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        Kini Cheese Tea menyajikan minuman kekinian dengan
                        perpaduan teh segar dan creamy cheese foam yang lembut.
                        Menggunakan bahan berkualitas dan rasa yang beragam,
                        setiap minuman menghadirkan sensasi manis, gurih, dan
                        segar dalam satu gelas. Dengan tampilan yang menarik dan
                        harga yang terjangkau, Kini Cheese Tea menjadi pilihan
                        favorit untuk para pecinta minuman modern.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1minuman4.jpg",
                        },
                        {
                          img: "menu2minuman4.jpg",
                        },
                        {
                          img: "menu3minuman4.jpg",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu4minuman4.jpg",
                        },
                        {
                          img: "menu5minuman4.jpg",
                        },
                        {
                          img: "menu6minuman4.jpg",
                        },
                      ].map((item, i) => (
                        <Col md="4" sm="6" key={i} className="mb-4">
                          <img
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Jl. A. YAni, Halubau Utara, Kec. Paringin Selatan,
                          Kabupaten Balangan
                        </Popup>
                      </Marker>
                    </MapContainer>
