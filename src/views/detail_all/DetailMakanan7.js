...
//  Lokasi
const LAT = -2.336601;
const LNG = 115.460906;

function DetailMakanan7() {
                ...
                <Col className="ml-auto mr-auto" md="8">
                  <Card className="card-blog card-plain text-center">
                    ...
                    <CardBody>
                      ...
                      >
                        Waroeng Jhuminten menyajikan aneka hidangan lezat dengan
                        harga yang tetap bersahabat. Menu-menu yang tersedia
                        sangat cocok untuk makan siang para pelajar yang
                        menginginkan makanan enak, hangat, dan mengenyangkan.
                        Tempat ini menjadi pilihan tepat untuk menikmati masakan
                        rumahan dengan rasa yang nyaman tanpa perlu mengeluarkan
                        biaya besar.
                      </p>
                    </CardBody>
                  </Card>
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1makanan7.jpg",
                          title: "Kwetiau",
                          price: "Rp 10.000",
                        },
                        {
                          img: "menu2makanan7.jpg",
                          title: "Nasi Uduk",
                          price: "Rp 15.000",
                        },
                        {
                          img: "menu3makanan7.jpg",
                          title: "Nasi Goreng",
                          price: "Rp 10.000",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu4makanan7.jpg",
                          title: "Mie Goreng",
                          price: "Rp 10.000",
                        },
                        {
                          img: "menu5makanan7.jpg",
                          title: "Nasi Mawut",
                          price: "Rp 10.000",
                        },
                        {
                          img: "menu6makanan7.jpg",
                          title: "Nasi Uduk Hati",
                          price: "Rp 15.000",
                        },
                      ].map((item, i) => (
                        <Col md="4" sm="6" key={i} className="mb-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Unnamed Road, Bungin, Kec. Paringin Selatan
                        </Popup>
                      </Marker>
                    </MapContainer>
                  </div>
