...
//  Lokasi
const LAT = -2.336655;
const LNG = 115.461368;

function DetailMinuman1() {
                ...
                <Col className="ml-auto mr-auto" md="8">
                  <Card className="card-blog card-plain text-center">
                    ...
                    <CardBody>
                      ...
                      >
                        Hulo Kopi merupakan kedai kopi modern dengan desain
                        minimalis yang nyaman. Menghadirkan berbagai pilihan
                        kopi dengan cita rasa enak dan proses penyajian yang
                        berkualitas, tempat ini menjadi pilihan favorit para
                        remaja maupun dewasa. Suasananya yang santai membuat
                        Hulo Kopi cocok untuk tempat nongkrong di malam hari,
                        menikmati kopi sambil berbincang atau bersantai bersama
                        teman.
                      </p>
                    </CardBody>
                  </Card>
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1minuman1.jpg",
                          title: "Es Vanilla Latte",
                          price: "Rp 15.000",
                        },
                        {
                          img: "menu2minuman1.jpg",
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu3minuman1.jpg",
                          title: "Es Kopi Hazelnut",
                          price: "Rp 17.000",
                        },
                        {
                          img: "menu4minuman1.jpg",
                          title: "Es Lemonade",
                          price: "Rp 15.000",
                        },
                      ].map((item, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Jl. Gunung Pandau, Paringin Timur., Kec Paringin
                          Selatan
                        </Popup>
                      </Marker>
                    </MapContainer>
