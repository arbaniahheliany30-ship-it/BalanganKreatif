...
//  Lokasi
const LAT = -2.414299;
const LNG = 115.430566;

function DetailMakanan5() {
                  ...
                  <Card className="card-blog card-plain text-center">
                    <div className="card-image">
                      <img
                        ...
                        src={require("assets/img/detailmakanan/DetailMakanan5.jpg")}
                        style={{
                          borderRadius: "14px",
                          maxHeight: "440px",
                          width: "100%",
                    ...
                    <CardBody>
                      ...
                      >
                        Warung Mandai Paman Gundul adalah UMKM yang menyediakan
                        berbagai olahan mandai khas Balangan. Produk utamanya
                        berupa mandai fermentasi dan keripik mandai yang dibuat
                        dari bahan pilihan. Keripik tersedia dalam rasa original
                        serta aneka rasa lainnya yang gurih dan renyah. Semua
                        produk dibuat fresh dan dikemas higienis, sehingga cocok
                        sebagai camilan harian maupun oleh-oleh khas Balangan.
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                ...
                >
                  ...
                  <Container>
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu1makanan5.jpg",
                        },
                        {
                          img: "menu2makanan5.jpg",
                        },
                      ].map((item, i) => (
                    ...
                    <Row className="justify-content-center">
                      {[
                        {
                          img: "menu3makanan5.jpg",
                        },
                        {
                          img: "menu4makanan5.jpg",
                        },
                      ].map((item, i) => (
                        <Col md="4" sm="6" key={i} className="mb-4">
                          <img
                  ...
                  >
                    ...
                    >
                      ...
                      <Marker position={[LAT, LNG]} icon={customIcon}>
                        <Popup>
                          Jl. A. Yani, Batu Mandi, Kec. Batu Mandi, Kabupaten
                          Balangan
                        </Popup>
                      </Marker>
                    </MapContainer>
